...
contract Erc20Token is Token {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "ErcToken: Only Owner can access");
        _;
    }
    ...
    function transfer(address _to, uint256 _tokens) external returns (bool) {
        require(balances[msg.sender] >= _tokens, "ErcToken: Failed!");
    ...
    function approve(address _from, uint256 _tokens) external returns (bool) {
        require(
            ...
            "ErcToken: insuficient balance for approval"
        );
